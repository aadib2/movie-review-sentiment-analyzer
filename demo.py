...
with col1:
    if st.button("😊 Positive Example"):
        review_input = "This movie was absolutely fantastic! Amazing acting and brilliant storyline."

with col2:
    if st.button("😞 Negative Example"):  
        review_input = "Terrible movie. Boring plot and awful acting. Complete waste of time."

# Then your text area
review_input = st.text_area(
    "📝 Enter your movie review here!", 
    value=review_input if 'review_input' in locals() else "", # FIGURE OUT WHY BUTTONS AREN'T WORKING
    placeholder="Type your movie review here...",
    height=150
)

if(st.button('Predict') and review_input is not None):
    ...
    prob = model_lr_best.predict_proba(vectorized_review) # POTENTIALLY create table to show probabilities
